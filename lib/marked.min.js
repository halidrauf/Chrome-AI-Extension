...
!(function (e, t) {
  ...
  const i = {
    ...
    $ = /^( {2,}|\\)\n(?!\s*$)/,
    R = /\p{P}\p{S}/u,
    T = r(/^((?![*_])[\spunctuation])/, "u")
      .replace(/punctuation/g, R)
      .getRegex(),
    z = r(
    ...
    O = { normal: x, gfm: w, pedantic: m },
    Q = { normal: Z, gfm: D, breaks: M, pedantic: v },
    j = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
    N = (e) => j[e];
  function G(e, t) {
    if (t) {
  ...
  class J {
    ...
    list(e) {
      ...
      if (t) {
        ...
        for (; e; ) {
          ...
          if (
            ...
            for (; e; ) {
              ...
              if (
                ...
                this.options.pedantic
                  ? ((c = c.replace(this.rules.other.listReplaceNesting, "  ")),
                    (k = c))
                  : (k = c.replace(this.rules.other.tabCharGlobal, "    ")),
                r.test(c))
              )
                break;
              if (i.test(c)) break;
              ...
              if (t.test(c)) break;
              if (n.test(c)) break;
              if (k.search(this.rules.other.nonSpaceChar) >= p || !c.trim())
                o += "\n" + k.slice(p);
              else {
                if (h) break;
                if (
          ...
          let u,
            k = null;
          this.options.gfm &&
            ((k = this.rules.other.listIsTask.exec(o)),
            k &&
              ((u = "[ ] " !== k[0]),
        ...
        o && ((o.raw = o.raw.trimEnd()), (o.text = o.text.trimEnd())),
          (r.raw = r.raw.trimEnd());
  ...
  class K {
    ...
    constructor(t) {
      ...
      this.options.pedantic
        ? ((n.block = O.pedantic), (n.inline = Q.pedantic))
        : this.options.gfm &&
          ((n.block = O.gfm),
          this.options.breaks ? (n.inline = Q.breaks) : (n.inline = Q.gfm)),
    ...
    onError(e, t) {
      return (n) => {
        if (
          ...
          const e =
            "<p>An error occurred:</p><pre>" + G(n.message + "", !0) + "</pre>";
